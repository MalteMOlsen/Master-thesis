...
write_csv(training_data, 
          "three_months_training_data_for_influent.csv")
...
#Save the data as a csv file
write_csv(test_data, 
          "three_months_validation_data_for_influent.csv")
...
write_csv(training_data_FT_subtracted, 
          "three_months_training_data_FT_subtracted_for_influent.csv")
...
write_csv(test_data_FT_subtracted, 
          "three_months_validation_data_fo_FT_subtractedr_influent.csv")
...
write_csv(training_data_FT_without_yearly_subtracted, 
          "three_months_training_data_FT_without_yearly_subtracted_for_influent.csv")
...
write_csv(test_data_FT_without_yearly_subtracted, 
          "three_months_validation_data_FT_without_yearly_subtracted_for_influent.csv")



#For the data frame without seasonality adjustment
model_data %>% 
  filter_index("2021-10-01"~"2021-10-14") %>% 
  write_csv("test.csv")
