...
folder_name = "All_XGB_models_with_valid_accuracy"
...
for (file in list_of_filenames){
  ...
  if (file=="XGB_default_AR_375_ammonium_and_AR_350_rain_drought_and_seasonality_accuracy_all_forecasting_horizon.csv"){
    file='Seasonal off-the-shelf XGBoost'
  }
  if (file=="XGB_default_AR_375_ammonium_and_AR_350_rain_accuracy_all_forecasting_horizon.csv"){
    file='Off-the-shelf XGBoost'
  }
  if (file=="XGB_with_AN_tank_hyperparameters_optimasation.csv"){
    file='SMBO optimised XGBoost '
  }
  if (file=="XGB_with_AN_tank_hyperparameters_optimasation_with_weather_forecast.csv"){
    file='XGBoost including weather forecast'
  }
