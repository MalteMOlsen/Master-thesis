#///////////////////////////////////////////////////////////////////////////////
#Training the linear models and the ARIMA models - one year of training
#///////////////////////////////////////////////////////////////////////////////
#The purpose of this script is to train the ARIMA models and the linear models
#on one year of training data.
...
#choosing the the working directory to be here
setwd("C:/Users/malte/OneDrive/Dokumenter/GitHub/Master-thesis/Master-thesis-R-project/models_and_analysis/ARIMA_and_linear_models/saved_models/one_year_of_training_data")
#Save the model 
ARIMA_d_0 %>% 
  saveRDS("ARIMA_d_0_one_year.rds")
...
#Save the model 
ARIMA_500 %>% 
  saveRDS("ARIMA_5000_one_year.rds")
...
#Save the model 
NAIVE_model %>% 
  saveRDS("NAIVE_model_one_year.rds")
...
#Save the model 
NNETAR_model %>% 
  saveRDS("NNETAR_model_one_year.rds")
...
#Save the model 
ARIMA_d_0_w_FT %>% 
  saveRDS("ARIMA_d_0_w_FT_one_year.rds")
...
#Save the model 
ARIMA_d_0_w_FT_large %>% 
  saveRDS("ARIMA_d_0_w_FT_large_one_year.rds")
...
#Save the model 
ARIMA_48_w_FT %>% 
  saveRDS("ARIMA_48_w_FT_one_year.rds")
...
#Save the model 
ARIMA_48_w_FT_large %>% 
  saveRDS("ARIMA_48_w_FT_large_one_year.rds")
...
#Save the model 
TSLM_R_R1_R2_R3_R4_R5_R6_R7 %>% 
  saveRDS("TSLM_R_R1_R2_R3_R4_R5_R6_R7_one_year.rds")
...
#Save the model 
TSLM_R_AllLagR_AllAccumR %>% 
  saveRDS("TSLM_R_AllLagR_AllAccumR_one_year.rds")
...
#Save the model 
TSLM_R_AllLagR_AllAccumR_w_FT %>% 
  saveRDS("TSLM_R_AllLagR_AllAccumR_w_FT_one_year.rds")
...
#Save the model 
TSLM_R_AllLagR_AllAccumR_w_FT_DI %>% 
  saveRDS("TSLM_R_AllLagR_AllAccumR_w_FT_DI_one_year.rds")
...
#Save the model 
TSLM_R_AllLagR_AllAccumR_w_FT_DI_w_AllDIxR %>% 
  saveRDS("TSLM_R_AllLagR_AllAccumR_w_FT_DI_w_AllDIxR_one_year.rds")
...
#Save the model 
TSLM_R_AllLagR_AllAccumR_w_FT_DI_w_AllDIxRw_ARIMA_500_w_mean_errors_ONLY_AS_TSLM %>% 
  saveRDS("TSLM_R_AllLagR_AllAccumR_w_FT_DI_w_AllDIxRw_ARIMA_500_w_mean_errors_ONLY_AS_TSLM_one_year.rds")
...
#Save the model 
TSLM_R_AllLagR_AllAccumR_w_FT_DI_w_AllDIxRw_ARIMA_48_w_mean_errors %>% 
  saveRDS("TSLM_R_AllLagR_AllAccumR_w_FT_DI_w_AllDIxRw_ARIMA_48_w_mean_errors_one_year.rds")
...
#Save the model 
TSLM_R_AllLagR_AllAccumR_w_FT_large_DI_w_AllDIxRw_ARIMA_48_w_mean_errors %>% 
  saveRDS("TSLM_R_AllLagR_AllAccumR_w_FT_large_DI_w_AllDIxRw_ARIMA_48_w_mean_errors_one_year.rds")
