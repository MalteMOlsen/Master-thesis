#///////////////////////////////////////////////////////////////////////////////
#Training the linear models and the ARIMA models - half a year of training
#///////////////////////////////////////////////////////////////////////////////
#The purpose of this script is to train the ARIMA models and the linear models
#on half a year of training data.
...
#choosing the the working directory to be here
setwd("C:/Users/malte/OneDrive/Dokumenter/GitHub/Master-thesis/Master-thesis-R-project/models_and_analysis/ARIMA_and_linear_models/saved_models/half_a_year_of_training_data")
#Save the model 
ARIMA_d_0 %>% 
  saveRDS("ARIMA_d_0_half_a_year.rds")
...
#Save the model 
ARIMA_500 %>% 
  saveRDS("ARIMA_5000_half_a_year.rds")
...
#Save the model 
NAIVE_model %>% 
  saveRDS("NAIVE_model_half_a_year.rds")
...
#Save the model 
NNETAR_model %>% 
  saveRDS("NNETAR_model_half_a_year.rds")
...
#Save the model 
ARIMA_d_0_w_FT %>% 
  saveRDS("ARIMA_d_0_w_FT_half_a_year.rds")


#----------------------------------
#ARIMA_d_0_w_FT_no_year_FT
#----------------------------------
ARIMA_d_0_w_FT_no_year_FT <- training_data %>% 
  model(
    TSLM(ammonium_load_AN_kg_h ~ 0+
           load_ammonium_AN_lag1+
           load_ammonium_AN_lag2+
...
#Save the model 
ARIMA_d_0_w_FT_no_year_FT %>% 
  saveRDS("ARIMA_d_0_w_FT_no_year_FT_half_a_year.rds")
...
#Save the model 
ARIMA_d_0_w_FT_large %>% 
  saveRDS("ARIMA_d_0_w_FT_large_half_a_year.rds")
...
#Save the model 
ARIMA_48 %>% 
  saveRDS("ARIMA_48_half_a_year.rds")
...
#Save the model 
ARIMA_48_w_FT %>% 
  saveRDS("ARIMA_48_w_FT_half_a_year.rds")
...
#Save the model 
ARIMA_48_w_FT_large %>% 
  saveRDS("ARIMA_48_w_FT_large_half_a_year.rds")
...
#Save the model 
FT_large %>% 
  saveRDS("FT_large_half_a_year.rds")
...
#Save the model 
TSLM_R %>% 
  saveRDS("TSLM_R_half_a_year.rds")
...
#Save the model 
TSLM_R_R1_R2_R3_R4_R5_R6_R7 %>% 
  saveRDS("TSLM_R_R1_R2_R3_R4_R5_R6_R7_half_a_year.rds")
...
#Save the model 
TSLM_R_AllLagR_AllAccumR %>% 
  saveRDS("TSLM_R_AllLagR_AllAccumR_half_a_year.rds")
...
#Save the model 
TSLM_R_AllLagR_AllAccumR_w_FT %>% 
  saveRDS("TSLM_R_AllLagR_AllAccumR_w_FT_half_a_year.rds")
...
#Save the model 
TSLM_R_AllLagR_AllAccumR_w_FT_DI %>% 
  saveRDS("TSLM_R_AllLagR_AllAccumR_w_FT_DI_half_a_year.rds")
...
#Save the model 
TSLM_R_AllLagR_AllAccumR_w_FT_DI_w_AllDIxR %>% 
  saveRDS("TSLM_R_AllLagR_AllAccumR_w_FT_DI_w_AllDIxR_half_a_year.rds")
...
#Save the model 
TSLM_R_AllLagR_AllAccumR_w_FT_DI_w_AllDIxRw_ARIMA_500_w_mean_errors_ONLY_AS_TSLM %>% 
  saveRDS("TSLM_R_AllLagR_AllAccumR_w_FT_DI_w_AllDIxRw_ARIMA_500_w_mean_errors_half_a_year.rds")
...
#Save the model 
TSLM_R_AllLagR_AllAccumR_w_FT_DI_w_AllDIxRw_ARIMA_48_w_mean_errors %>% 
  saveRDS("TSLM_R_AllLagR_AllAccumR_w_FT_DI_w_AllDIxRw_ARIMA_48_w_mean_errors_half_a_year.rds")
...
#Save the model 
TSLM_R_AllLagR_AllAccumR_w_FT_large_DI_w_AllDIxRw_ARIMA_48_w_mean_errors %>% 
  saveRDS("TSLM_R_AllLagR_AllAccumR_w_FT_large_DI_w_AllDIxRw_ARIMA_48_w_mean_errors_half_a_year.rds")
