...
#Column
#Target column
target_column = "ammonium_load_PT3_kg_h"
...
X_training.to_csv("X_training_process_tank_3_with_test_set.csv")
X_test.to_csv("X_test_process_tank_3_with_test_set.csv")
target_training.to_csv("target_training_process_tank_3_with_test_set.csv")
target_test.to_csv("target_valid_process_tank_3_with_test_set.csv")
