...
#Column
#Target column
target_column = "ammonium_load_PT4_kg_h"
...
list_of_features_to_be_lagged = ["ammonium_load_AN_kg_h",
                                 "rainfall_mm",
                                 "T_PT4_C",
                                 "airflow_PT4_m3_h",
                                 "SS_PT4_g_L"]
...
X_training.to_csv("X_training_process_tank_4_with_test_set.csv")
X_test.to_csv("X_test_process_tank_4_with_test_set.csv")
target_training.to_csv("target_training_process_tank_4_with_test_set.csv")
target_test.to_csv("target_valid_process_tank_4_with_test_set.csv")
