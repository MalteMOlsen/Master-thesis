...
for i in range(1,49,1):
    ...
    X_training.to_csv(str(forecasting_horizon)+"X_training_with_test_set.csv")
    print("1_fh"+str(forecasting_horizon))
    X_valid.to_csv(str(forecasting_horizon)+"X_valid_with_test_set.csv")
    print("2_fh"+str(forecasting_horizon))
    target_valid_load.to_csv(str(forecasting_horizon)+"target_valid_load_with_test_set.csv")
    print("3_fh"+str(forecasting_horizon))
    seasonal_adjusted_df_valid.to_csv(str(forecasting_horizon)+"seasonal_adjusted_df_valid_with_test_set.csv")
    print("4_fh"+str(forecasting_horizon))
    target_training_resid.to_csv(str(forecasting_horizon)+"target_training_resid_with_test_set.csv")
