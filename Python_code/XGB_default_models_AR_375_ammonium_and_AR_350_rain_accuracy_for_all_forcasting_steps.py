...
for i in range(1,49,1):  
    ...
    weight_plot.figure.savefig("Feature_importance_weight_forecasting_horizon_"+str(forecasting_horizon)+"_of_the_shelf_XGBoost.png")
    ...
    gain_plot.figure.savefig("Feature_importance_gain_forecasting_horizon_"+str(forecasting_horizon)+"_of_the_shelf_XGBoost.png")
    
    #Prediction how well the model fits training and validation data
    training_pred    = xgb.predict(X_training)
...
preformace_table.to_csv("XGB_default_AR_375_ammonium_and_AR_350_rain_accuracy_all_forecasting_horizon.csv")
