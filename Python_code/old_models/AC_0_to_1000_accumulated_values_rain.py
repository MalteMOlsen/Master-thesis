...
df_training = df_training.loc[:, ["rainfall_mm", "ammonium_load_AN_kg_h"]]
#Load validation data
df_valid = df_valid.loc[:, ["rainfall_mm", "ammonium_load_AN_kg_h"]]


extra_valid_data = df_training
#//////////////////////////////////////////////////////////////////////////////////////////////
#Rain accumulated - future rain is not known
#//////////////////////////////////////////////////////////////////////////////////////////////
...
for accumulator in broaders:
        ...
        df_training.loc[:,"rainfall_mm"+"_lag_"+str(1)] = df_training["rainfall_mm"].shift(1)
        df_valid.loc[:,"rainfall_mm"+"_lag_"+str(1)] = df_valid["rainfall_mm"].shift(1)
        
        #Lagging or accumulating the chosen column
        df_training.loc[:,"rainfall_mm"+"_AC_"+str(accumulator)] = df_training["rainfall_mm_lag_1"].rolling(window=accumulator).sum()
        df_valid.loc[:,"rainfall_mm"+"_AC_"+str(accumulator)] = df_valid["rainfall_mm_lag_1"].rolling(window=accumulator).sum()
...
preformace_table.to_csv("AC_0_to_1000_accumulated_rainfall_step_1.csv")
