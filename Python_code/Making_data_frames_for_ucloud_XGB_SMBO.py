...
for i in range(1,49,1):
    ...
    X_training.to_csv(str(forecasting_horizon)+"X_training.csv")
    print("1_fh"+str(forecasting_horizon))
    X_valid.to_csv(str(forecasting_horizon)+"X_valid.csv")
    print("2_fh"+str(forecasting_horizon))
    target_valid_load.to_csv(str(forecasting_horizon)+"target_valid_load.csv")
    print("3_fh"+str(forecasting_horizon))
    seasonal_adjusted_df_valid.to_csv(str(forecasting_horizon)+"seasonal_adjusted_df_valid.csv")
    print("4_fh"+str(forecasting_horizon))
    target_training_resid.to_csv(str(forecasting_horizon)+"target_training_resid.csv")
