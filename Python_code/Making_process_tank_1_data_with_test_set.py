...
#expand the training data to include the validation set
...
X_training.to_csv("X_training_process_tank_1_with_test_set.csv")
X_test.to_csv("X_test_process_tank_1_with_test_set.csv")
target_training.to_csv("target_training_process_tank_1_with_test_set.csv")
target_test.to_csv("target_valid_process_tank_1_with_test_set.csv")
